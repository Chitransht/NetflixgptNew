  ...
  return (
    <div >
      <div className="absolute">
        <Header />
        <img
          className="h-screen object-cover md:h-[100%] fixed w-[100%] "
          src={BG_LOGO}
          alt="bg-logo"
        />
      </div>
      <form
        ...
        className="absolute bg-black w-full md:w-3/12 my-36 mx-auto right-0 left-0 text-white p-12 bg-opacity-80"
      >
